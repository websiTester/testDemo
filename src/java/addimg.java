...
public class addimg extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        out.println("File name: "+imgfileName);
        
        //Get upload path:
        String uploadPath = "C:\\Java\\ImageUpload\\web\\img\\"+imgfileName;
        out.println("Upload Path name: "+uploadPath);
        ...
        out.println("Display file:"+displayFileName);
        HttpSession session = request.getSession();
        session.setAttribute("displayFileName", displayFileName);
